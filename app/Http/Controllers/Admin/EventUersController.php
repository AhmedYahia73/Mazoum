                ...
                foreach($request->users as $arr) {
                    ...
                    if(array_key_exists('id', $arr)) {
                        ...
                        if($user_event != null) {
                            ...
                            $response = SendWeddingDataV1ArTemplate($to,$template_name,$language,$param_1,$param_2,$param_3,$param_4,$param_5,$param_6,$image_url,$phone_numer_id,$token, $header_type, $send_buttons);
