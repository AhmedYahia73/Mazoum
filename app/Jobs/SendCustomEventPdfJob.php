        ...
        try {
            ...
            <div style="position: absolute; bottom: 35mm; width: 100%; text-align: center;">
                <table cellpadding="0" cellspacing="0" dir="rtl" style="margin: 0 auto; border-collapse: separate; border-spacing: 15px 0;">
                    <tr>
                        <td style="width: 54mm; text-align: center; vertical-align: middle;">
                            <a href="' . $confirm_link . '" style="display: block; width: 100%; background-color: #22C55E; padding: 6px 0 12px 0; border-radius: 50px; color: #ffffff; text-decoration: none; font-family: \'dejavusans\', sans-serif; font-size: 12pt; font-weight: bold; line-height: 1;">تأكيد الحضور</a>
                        </td>
                        
                        <td style="width: 54mm; text-align: center; vertical-align: middle;">
                            <a href="' . $apologize_link . '" style="display: block; width: 100%; background-color: #EF4444; padding: 6px 0 12px 0; border-radius: 50px; color: #ffffff; text-decoration: none; font-family: \'dejavusans\', sans-serif; font-size: 12pt; font-weight: bold; line-height: 1;">الاعتذار عن الحضور</a>
                        </td>
                    </tr>
                </table>
            </div>';
