...
<div class="row">
  <div class="col-12">
    <p>
      <a href="{{asset('admin/currency/create')}}" id="addRow" class="btn btn-primary">
          ...
          <div class="table-responsive">
            ...
            <table class="table zero-configuration">
              ...
              <thead>
                <tr>
                    <th>#</th>
                    <th> أسم العملة باللغة الأنجليزية </th>
                    <th> أسم العملة باللغة العربية </th>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url('admin/currency/'). '/' . $value->id . '/edit'}}">
...
@section('footer')
    ...
    <script>
        ...
        function DeletingModal(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '{{ url('admin/currency/destroy') }}' + '/' + ID;
