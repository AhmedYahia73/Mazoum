    ...
    @if($event_users != null && $event_users->count() > 0)
        ...
        {{--  {!! Form::open(['url' => "admin/custom_event_users_search",'role'=>'form','id'=>'event_users_search','method'=>'get']) !!}
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => "admin/update_custom_event_users",'role'=>'form','id'=>'update_event_users','method'=>'post']) !!}
            ...
            @foreach ($event_users as $user)
                ...
                <div class="row" style="padding-left: 5.6%;">
                    ...
                    <div class="col-md-3 col-sm-3 {{ $errors->has('name') ? ' has-error' : '' }}" style="margin-bottom: 20px">
                        <label> أسم المستخدم  </label>
                    ...
                    <div class="col-md-3 col-sm-3 {{ $errors->has('mobile') ? ' has-error' : '' }}" style="margin-bottom: 20px">
                    ...
                    <div class="col-md-3 col-sm-3 {{ $errors->has('users_count') ? ' has-error' : '' }}" style="margin-bottom: 20px">
                        <label> عدد الدعوات </label>
                        <input type="number" min="1" name="old_event_users[{{$user->id}}][users_count]" class="form-control m-input" value="{{ $user->users_count }}"  placeholder="عدد الدعوات">
    ...
    {!! Form::open(['url' => "admin/save_custom_event_users",'role'=>'form','id'=>'save_event_users','method'=>'post']) !!}
    ...
    <div class="modal fade" id="ImportEventUsers" tabindex="-1" aria-labelledby="ImportEventUsersLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {!! Form::open(['url' => "admin/custom-event-user-import",'role'=>'form','id'=>'import_form','method'=>'post','files' => true]) !!}
