<div style="padding-top: 30px">
    ...
    @if($event_family != null && $event_family->count() > 0)
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => "admin/custom_event_family_search",'role'=>'form','id'=>'event_family_search','method'=>'get']) !!}
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => "admin/update_custom_event_family",'role'=>'form','id'=>'update_event_family','method'=>'post']) !!}
    ...
    {!! Form::open(['url' => "admin/save_custom_event_family",'role'=>'form','id'=>'save_event_family','method'=>'post']) !!}
