            ...
            <div class="card">
                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/custom_events/'.$Item->id.'/event-visitors') }}" class="nav-link" aria-selected="false">
                                زوار الحدث
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/custom_events/'.$Item->id.'/event-report') }}" class="nav-link active" aria-selected="false">
                                تقرير الحدث
                            </a>
                        </li>
                    ...
                    <div class="nav-align-top mb-4">
                        ...
                        <div class="tab-content" style="padding-top: 0;">
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel" style="padding-top: 30px">
                                @include('admin.custom_events.event_report')
                            </div>
