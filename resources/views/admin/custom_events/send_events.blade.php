      ...
      <div class="card">
        ...
        <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
            <ul class="nav nav-pills mb-3" role="tablist">
                ...
                <li class="nav-item">
                    <a href="{{ asset('admin/custom_events/'.$Item->id.'/send-events') }}" class="nav-link active" aria-selected="false">
                        أرسال الدعوات
                    </a>
                </li>
            ...
            <div class="nav-align-top mb-4">
                ...
                <div class="tab-content" style="padding-top: 0;">
                    ...
                    <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel" style="padding: 30px">
                        @include('admin.custom_events.send_event_users')
                    </div>
        ...
        $(document).ready(function () {
            ...
            $('.new_send_btn').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users').attr('action','{{ asset('admin/new-send-custom-event-invitation') }}').attr('method','post').submit();
                        }
                    }
                );
            });
          	...
          	$('#delete_selected_items_btn,.delete_selected_items_btn').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users').attr('action','{{ asset('admin/delete_selected_custom_event_users') }}').attr('method','post').submit();
                        }
                    }
                );
            });
          	...
          	$('#delete_selected_items_btn_v2,.delete_selected_items_btn_v2').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users_v2').attr('action','{{ asset('admin/delete_selected_custom_event_users') }}').attr('method','GET').submit();
                        }
                    }
                );
            });
