            ...
            <div class="card">
                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/edit') }}" class="nav-link " aria-selected="true">
                                تعديل
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/event-users') }}" class="nav-link active" aria-selected="true">
                                 دخول المناسبة
                            </a>
                        </li>
