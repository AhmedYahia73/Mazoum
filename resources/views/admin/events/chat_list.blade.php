        ...
        <div id="sidepanel">
            ...
            <div id="contacts">
                ...
                <ul>
                    ...
                    @foreach ($event_users as $event_user_row)
                        <li onclick="location.href='{{ asset('admin/events/'.$event->id.'/edit?event_user_id='.$event_user_row->id) }}'" class="contact {{ $event_user != null && $event_user->id == $event_user_row->id ? 'active' : '' }}">
                            <div class="wrap">
                             ...
                             <div class="card-body">
                               ...
                               <ul style="margin: 0;padding: 0;">
                                 <li style="color: #000;padding: 0;margin: 0;margin-bottom: 10px;">
                                     📆 وذلك بمشيئة الله يوم {{ $day_name }} الموافق {{ $event->date }}
                                 </li>
                                 <li style="color: #000;padding: 0;margin: 0;margin-bottom: 10px;">
                                     📍مكان الحفـل {{ $event->address }}
                                 </li>
                                 <li style="color: #000;padding: 0;margin: 0;margin-bottom: 10px;">
                                     ⏱️الساعـة {{ Carbon\Carbon::parse($event->time)->locale('ar')->translatedFormat('h:i A') }}
                                 </li>
                                 <li style="color: #000;padding: 0;margin: 0;margin-bottom: 10px;">
