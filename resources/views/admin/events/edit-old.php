                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item" style="display:none">
                            <a href="{{ asset('admin/event-report/'.$Item->id) }}" type="button" class="nav-link">
                                تقرير الحدث
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                      	...
                      	<li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-user-reports-v3" aria-controls="navs-user-reports-v3" aria-selected="false">
                                موقع الحدث
                            </button>
                        </li>
                      	...
                      	<li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-user-reports-v6" aria-controls="navs-user-reports-v6" aria-selected="false">
     							باقتي
                            </button>
                        </li>

                        <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-user-reports-v7" aria-controls="navs-user-reports-v7" aria-selected="false">
                                 المحادثات
                            </button>
                        </li>
