            ...
            <div class="card">
                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/edit') }}" class="nav-link active" aria-selected="true">
                                تعديل الحدث
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/event-visitors') }}" class="nav-link" aria-selected="false">
                                زوار الحدث
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/send-events') }}" class="nav-link" aria-selected="false">
                                أرسال الدعوات
                            </a>
                        </li>

                        <li class="nav-item" style="display:none">
                            <a href="{{ asset('admin/event-report/'.$Item->id) }}" class="nav-link" aria-selected="false">
                                تقرير الحدث
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/event-report') }}" class="nav-link" aria-selected="false">
                                تقرير الحدث
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/event-users') }}" class="nav-link" aria-selected="false">
                                مستخدمين الدعوه
                            </a>
                        </li>

                      	<li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/event-location') }}" class="nav-link" aria-selected="false">
                                موقع الحدث
                            </a>
                        </li>
                      	...
                      	<li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/enter-event') }}" class="nav-link" aria-selected="false">
                                 دخول المناسبة
                            </a>
                        </li>

                      	<li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/scanner') }}" class="nav-link" aria-selected="false">
                                 Scaner
                            </a>
                        </li>

                      	<li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/my-package') }}" class="nav-link" aria-selected="false">
     							باقتي
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/chat-list') }}" class="nav-link" aria-selected="false">
                                 المحادثات
                            </a>
                        </li>
                    ...
                    <div class="nav-align-top mb-4">
                        ...
                        <div class="tab-content" style="padding-top: 0;">
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.edit_form')
                            </div>

                            <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.event_visitors')
                            </div>

                            <div class="tab-pane fade" id="navs-pills-top-report" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.send_events')
                            </div>

                          	<div class="tab-pane fade" id="navs-user-reports-v1" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.event_report')
                            </div>

                            <div class="tab-pane fade" id="navs-user-reports-v2" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.event_users')
                            </div>

                          	<div class="tab-pane fade" id="navs-user-reports-v3" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.event_location')
                            </div>


                            <div class="tab-pane fade" id="navs-user-reports-v5" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.enter_event')
                            </div>

                            <div class="tab-pane fade" id="navs-user-reports-v4" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.scanner')
                            </div>

                          	<div class="tab-pane fade" id="navs-user-reports-v6" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.my_package')
                            </div>

                            <div class="tab-pane fade" id="navs-user-reports-v7" role="tabpanel" style="padding-top: 30px">
                                @include('admin.events.chat_list')
                            </div>
...
@section('footer')
        ...
        $(document).ready(function () {
            ...
            $('.new_send_btn').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users').attr('action','{{ asset('admin/new-send-event-invitation') }}').attr('method','post').submit();
                        }
                    }
                );
            });
          	...
          	$('#delete_selected_items_btn,.delete_selected_items_btn').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users').attr('action','{{ asset('admin/delete_selected_event_users') }}').attr('method','post').submit();
                        }
                    }
                );
            });
          	...
          	$('#delete_selected_items_btn_v2,.delete_selected_items_btn_v2').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users_v2').attr('action','{{ asset('admin/delete_selected_event_users') }}').attr('method','GET').submit();
                        }
                    }
                );
            });
            ...
            $('.DeletingFamily').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('admin/event_family/destroy') }}' + '/' + ID;
          	...
          	$('.open_event_family').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('admin/open_event_family') }}' + '/' + ID;
          ...
          $('.login_event').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('admin/login-user') }}' + '/' + ID;
          	...
          	$('.send_qr_code').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('admin/send-qr') }}' + '/' + ID;
          	...
          	$('.send_new_qr_code').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('admin/send-new-qr') }}' + '/' + ID;
          	...
          	$('.accept_event').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('admin/accept-user-event') }}' + '/' + ID;
          ...
          $('.qr_is_send').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('admin/qr-is-send') }}' + '/' + ID;
          ...
          $('.is_send_event').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('admin/is-send-event') }}' + '/' + ID;
          ...
          $('.refuse_event').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('admin/refuse-user-event') }}' + '/' + ID;
        ...
        $(function () {
            ...
            if (all_users_table.length) {
          	...
          	$('.SendCongratulationMessageToSelected').click(function() {
                ...
                $('#send_event_users').attr('action', '{{ url("admin/send-congratulation-message") }}').submit();
          	...
          	$('.SendApologizeMessageToSelected').click(function() {
                ...
                $('#send_event_users').attr('action', '{{ url("admin/send-apologize-message") }}').submit();
	...
	<script>
        ...
        function SendCongratulations(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '{{ url('admin/send-congratulations') }}' + '/' + ID;
	...
	<script src="https://maps.googleapis.com/maps/api/js?key={{env('API_GOOGLE_MAP')}}&libraries=places&callback=initMap" async defer></script>

    <script>
        function initMap() {

            var initialLat = '{{ $Item->lat != null ? $Item->lat : '29.378586' }}';
            var initialLong = '{{ $Item->long != null ? $Item->long : '47.990341' }}';
            ...
            */
            ...
            document.getElementById('lat').innerHTML = @if($Item->lat != null) {{ $Item->lat }} @else '' @endif;
            document.getElementById('lon').innerHTML = @if($Item->long != null) {{ $Item->long }} @else '' @endif;

            document.getElementById('lat2').value = marker.getPosition().lat();
            document.getElementById('lon2').value = marker.getPosition().lng();

            document.getElementById('country2').value = '{{ $Item->country != null ? $Item->country : 'United Arab Emirates' }}';
            document.getElementById('location2').value = '{{ $Item->location != null ? $Item->location : 'Dubai - United Arab Emirate' }}';
    ...
    <script>
        ...
        function sendMessageToSelected() {
            swal({
              ...
              function (isConfirm) {
                if (isConfirm) {
                  $('#send_event_users').attr('action', '{{ url("admin/send-custom-message") }}').submit();
                }
              });
        }
	...
	<script src="{{ asset('qr_code_program/html5-qrcode.min.js') }}"></script>
