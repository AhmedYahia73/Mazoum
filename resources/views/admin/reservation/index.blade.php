...
<div class="row">
  <div class="col-12">
    <p>
      <a href="{{asset('admin/reservation/create')}}" id="addRow" class="btn btn-primary">
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url('admin/reservation/'). '/' . $value->id . '/edit'}}">
...
@section('footer')
    ...
    <script>
        ...
        function DeletingModal(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '{{ url('admin/reservation/destroy') }}' + '/' + ID;
