      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <ul class="nav nav-tabs" style="margin-bottom:20px">
            <li class="nav-item">
              <a class="nav-link {{ request()->is('admin/sa-events') ? 'active active_nav_item' : '' }}" aria-current="page" href="{{ asset('admin/sa-events') }}">
              	المناسبات
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ request()->is('admin/sa-current-events') ? 'active active_nav_item' : '' }}" href="{{ asset('admin/sa-current-events') }}">
              	  المناسبات الحاليه
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ request()->is('admin/sa-closed-events') ? 'active active_nav_item' : '' }}" href="{{ asset('admin/sa-closed-events') }}">
              	المناسبات المنهية
              </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/sa-deleted-events') ? 'active active_nav_item' : '' }}" href="{{ asset('admin/sa-deleted-events') }}">
                    المناسبات المحذوفه
                </a>
              </li>
          </ul>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @elseif(request()->is('admin/sa-current-events'))
                                    <a onclick="return closeEventModal({{ $value->id }});" class="dropdown-item closeEventModal" name="{{ $value->id }}" href="javascript:void(0);">
                                        <i class="bx bx-window-close me-1"></i> المناسبات المنهية
                                    </a>
                                    @else
