            ...
            <div class="card">
                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/edit') }}" class="nav-link " aria-selected="false">
                                تعديل
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('admin/events/'.$Item->id.'/send-events') }}" class="nav-link active" aria-selected="true">
                                أرسال الدعوات
                            </a>
                        </li>
        ...
        $(document).ready(function () {
            ...
            $('.old_send_btn').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users').attr('action','{{ asset('admin/send_event_users') }}').attr('method','post').submit();
                        }
                    }
                );
            });
            ...
            $('.send_location').on('click', function () {
                ...
                swal({
                        title: "هل تريد حقا ارسال موقع الحفل لهذا المستخدم",
                        text: "",
                        type: "warning",
                        showCancelButton: true,
                        confirmButtonColor: "#DD6B55",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('admin/send-event-location') }}' + '/' + ID;
        ...
        $(function () {
            ...
            if (all_users_table.length) {
          	...
          	$('.SendCongratulationMessageToSelected').click(function() {
                ...
                var msg1 = formDev.find('#msg_v1_'+ID).val();
          	...
          	$('.SendApologizeMessageToSelected').click(function() {
                ...
                var msg2 = formDev.find('#msg_v2_'+ID).val();
