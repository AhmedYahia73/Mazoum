...
<div class="row">
  <div class="col-12">
    <p>
      <a href="{{asset('admin/web_desgins/create')}}" id="addRow" class="btn btn-primary">
              ...
              <tbody>
                ...
                @foreach($Item as $value)
                  ...
                  <tr>
                      ...
                      @else
                      <td>
                        <a href="{{ asset('admin/web_desgins/show-pdf/'.$value->id) }}" target="_blank">
                            Open PDF
                        </a>
                      </td>
                      @endif
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url('admin/web_desgins/'). '/' . $value->id . '/edit'}}">
...
@section('footer')
    ...
    <script>
        ...
        function DeletingModal(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '{{ url('admin/web_desgins/destroy') }}' + '/' + ID;
