<div style="padding-top: 30px">
    ...
    @if($event_family != null && $event_family->count() > 0)
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => "assistant_panel/custom_event_family_search",'role'=>'form','id'=>'event_family_search','method'=>'get']) !!}
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => "assistant_panel/update_custom_event_family",'role'=>'form','id'=>'update_event_family','method'=>'post']) !!}
    ...
    {!! Form::open(['url' => "assistant_panel/save_custom_event_family",'role'=>'form','id'=>'save_event_family','method'=>'post']) !!}
