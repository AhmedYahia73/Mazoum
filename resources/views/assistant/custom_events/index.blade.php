...
<section id="basic-datatable">
  ...
  <div class="row">
    <div class="col-12">
      ...
      {!! Form::open(['url' => "assistant_panel/delete_selected_custom_events", 'role'=>'form','id'=>'delete_selected_items','method'=>'post']) !!}
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{ url('assistant_panel/custom_events/'). '/' . $value->id . '/edit'}}">
...
@section('footer')
 ...
 <script>
    ...
    function DeletingModal(ID) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                window.location.href = '{{ url('assistant_panel/custom_events/destroy') }}' + '/' + ID;
            }
        });
    }
