                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item" style="display:none">
                            <a href="{{ asset('assistant_panel/event-report/'.$Item->id) }}" type="button" class="nav-link">
                                تقرير الحدث
                            </a>
                        </li>
...
@section('footer')
        ...
        $(document).ready(function () {
            ...
            $('.DeletingUser').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('assistant_panel/event_users/destroy') }}' + '/' + ID;
            ...
            $('.DeletingFamily').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('assistant_panel/event_family/destroy') }}' + '/' + ID;
          	...
          	$('.open_event_family').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('assistant_panel/open_event_family') }}' + '/' + ID;
          ...
          $('.login_event').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('assistant_panel/login-user') }}' + '/' + ID;
          	...
          	$('.send_qr_code').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('assistant_panel/send-qr') }}' + '/' + ID;
          	...
          	$('.accept_event').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('assistant_panel/accept-user-event') }}' + '/' + ID;
          ...
          $('.qr_is_send').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('assistant_panel/qr-is-send') }}' + '/' + ID;
          ...
          $('.is_send_event').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('assistant_panel/is-send-event') }}' + '/' + ID;
          ...
          $('.refuse_event').on('click', function () {
                ...
                swal({
                  ...
                  closeOnCancel: true
                     ...
                     function (isConfirm) {
                  if (isConfirm) {
                    window.location.href = '{{ url('assistant_panel/refuse-user-event') }}' + '/' + ID;
	...
	<script>
        ...
        function SendCongratulations(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '{{ url('assistant_panel/send-congratulations') }}' + '/' + ID;
    ...
    <script>
        ...
        function sendMessageToSelected() {
            swal({
              ...
              function (isConfirm) {
                if (isConfirm) {
                  $('#send_event_users').attr('action', '{{ url("assistant_panel/send-custom-message") }}').submit();
                }
              });
        }
		...
		function SendCongratulationMessageToSelected() {
            swal({
              ...
              function (isConfirm) {
                if (isConfirm) {
                  $('#send_event_users').attr('action', '{{ url("assistant_panel/send-congratulation-message") }}').submit();
                }
              });
        }
      	...
      	function SendApologizeMessageToSelected() {
            swal({
              ...
              function (isConfirm) {
                if (isConfirm) {
                  $('#send_event_users').attr('action', '{{ url("assistant_panel/send-apologize-message") }}').submit();
                }
              });
        }
