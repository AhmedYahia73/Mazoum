...
<!--begin::Form-->
{!! Form::open(['url' => "assistant_panel/event_family_search",'role'=>'form','id'=>'event_family_search','method'=>'get']) !!}
...
<!--begin::Form-->
{!! Form::open(['url' => "assistant_panel/update_event_family",'role'=>'form','id'=>'update_event_family','method'=>'post']) !!}
...
{!! Form::open(['url' => "assistant_panel/save_event_family",'role'=>'form','id'=>'save_event_family','method'=>'post']) !!}
