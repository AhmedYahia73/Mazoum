    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                <h2>
                    {{ App\Models\EventMessages::whereHas('event',function($event) { $event->where('is_open','yes'); })->whereIn('mobile',$mobiles_arr)->count() }}
                </h2>
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/event-messages/'.$Item->id) }}">
                        الرسائل
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/all-invited-users/'.$Item->id) }}">
                        ضيوف المناسبة
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/event-qr-details/'.$Item->id) }}">
                        QR
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/confirmed-event-details/'.$Item->id) }}">
                        التاكيد
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/not-attend-event-details/'.$Item->id) }}">
                        الأعتذار
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/hold-event-details/'.$Item->id) }}">
                        بأنتظار الأرسال
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/failed-event-details/'.$Item->id) }}">
                      لم يتم التاكيد
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/qr-sent-event-details/'.$Item->id) }}">
                        Sent QR
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/congratulations-event-messages-details/'.$Item->id) }}">
                        رسائل التهنئة
                    </a>
                </span>
            </div>
  ...
  <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/non-attendance-event-details/'.$Item->id) }}">
                    	عدم الحضور
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="{{ asset('assistant_panel/confirmed-users-web-chat/'.$Item->id) }}">
