            ...
            <div class="wrap-login100">
                ...
                {!! Form::open(array('url' => 'event/login', 'class' => 'login100-form validate-form')) !!}
                    ...
                    <div class="wrap-input100 validate-input" style="position: relative" data-validate = "Valid mobile is required">
                        ...
                        <input class="input100" type="number" name="phone" required value="{{ old('mobile') }}" placeholder=" رقم الموبيل " style="border-radius: 0;direction: rtl;text-align: right;padding-right: 32%;padding-left: 0;">
