...
@section('header')
    ...
    <style>
      ...
      #main-banner {
        background-image: url({{ asset('logo/home-cover.jpg') }}) !important;
      }
...
@section('content')
    ...
    <!-- Banner Start -->
    <section class="main-banner back-img" id="main-banner" style="background-image: url('{{ asset('website/assets/images') }}/banner-bg.jpg');">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="banner-content">
                        ...
                        <div class="banner-btn wow fadeup-animation" data-wow-delay="0.6s">
                            <a href="{{ asset('أتصل-بنا') }}" title="Contact Us Now" class="sec-btn"><span> تواصل معنا </span></a>
                      	...
                      	<div>
                            <a href="" target="_blank" style="display: inline-block;">
                            	<img src="{{ asset('google.png') }}" style="max-width: 300px;margin-top: 25px;height: 75px;">  
                            </a>
                          	<a href="https://apps.apple.com/kw/app/mazoom-معزوم/id6450513282" target="_blank"  style="display: inline-block;">
                            	<img src="{{ asset('apple.png') }}" style="max-width: 300px;margin-top: 25px;height: 75px;">  
                            </a>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="banner-img wow fadeup-animation" data-wow-delay="0.5s">
                        <img src="{{ asset('logo/home-v2.png') }}" alt="Banner Image">
                    </div>
                </div>
            </div>
        </div>
				...
				<div class="col-lg-6">
					<div class="main-about-img wow right-animation" data-wow-delay="0.4s">
						<div class="about-img-box">
							<div class="about-img img_hover back-img" style="background-image: url('{{ asset('logo/about-cover.jpg') }}?{{ rand() }}');"></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="about-content wow left-animation" data-wow-delay="0.4s">
						...
						<a href="{{ asset('من-نحن') }}" class="sec-btn" title="Contact Us Now"><span> المزيد </span></a>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="pricing-title">
                        <span class="sub-title"> {{ trans('home.Pricing') }} </span>
                        <h2 class="h2-title"> {{ $lang == 'en' ? 'Choose Price Plan' : 'اختر خطة الأسعار' }} </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="project-title">
                        <span class="sub-title" id="portfolio">{{ trans('home.Desgins') }}</span>
                        <h2 class="h2-title">{{ $lang == 'en' ? 'Our Work Portfolio' : 'اعمالنا' }}</h2>
                    </div>
                </div>
            </div>
    ...
    <section class="main-testimonial">
        <div class="testimonial-animate">
            <div class="testimonial-img testimonial-img1 back-img" style="background-image: url('{{ asset('logo/so-1.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img2 back-img" style="background-image: url('{{ asset('logo/so-2.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img3 back-img" style="background-image: url('{{ asset('logo/so-3.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img4 back-img" style="background-image: url('{{ asset('logo/so-4.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img5 back-img" style="background-image: url('{{ asset('logo/so-5.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img6 back-img" style="background-image: url('{{ asset('logo/so-1.png') }}?{{ rand() }}');"></div>>
            <div class="testimonial-img testimonial-img7 back-img" style="background-image: url('{{ asset('logo/so-2.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img8 back-img" style="background-image: url('{{ asset('logo/so-3.png') }}?{{ rand() }}');"></div>>
            <div class="testimonial-img testimonial-img9 back-img" style="background-image: url('{{ asset('logo/so-4.png') }}?{{ rand() }}');"></div>
            <div class="testimonial-img testimonial-img10 back-img" style="background-image: url('{{ asset('logo/so-5.png') }}?{{ rand() }}');"></div>v>
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="main-testimonial-box">
                        <span class="quote">
                            <img src="{{ asset('website/assets') }}/images/quote-icon.png" alt="Quote Icon">
                        </span>
                        <div class="main-testimonial-slider back-img" style="background-image: url('{{ asset('website/assets/images') }}/testimonial-bg.jpg');">
