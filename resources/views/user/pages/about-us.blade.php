...
@section('content')
    ...
    <!-- Banner Start -->
	<section class="main-banner inner-banner back-img" id="main-banner" style="background-image: url('{{ asset('logo/about-us.jpg') }}');">
		<div class="container">
			<div class="row">
				<div class="col-12">
...
">
						...
						<div class="who-we-are-list">
							<div class="who-we-are-list-box">
								<div class="who-we-are-list-icon">
									<img src="{{ asset('website/assets/images') }}/our-vision-icon.png" alt="Our Vision">
								</div>
							...
							<div class="who-we-are-list-box">
								<div class="who-we-are-list-icon">
									<img src="{{ asset('website/assets/images') }}/our-mission-icon.png" alt="Our Mission">
								</div>
								<div class="who-we-are-list-text">
							...
							<div class="who-we-are-list-box">
								<div class="who-we-are-list-icon">
									<img src="{{ asset('website/assets/images') }}/our-goals-icon.png" alt="Our Goals">
								</div>
								<div class="who-we-are-list-text">
				...
				<div class="col-lg-6 order-lg-2 order-1">
					<div class="who-we-are-img wow left-animation" data-wow-delay="0.2s">
						<img src="{{ asset('logo/vision.png') }}?{{ rand() }}" alt="Who We Are">
					</div>
				</div>
			</div>
		</div>
