...
@section('content')
    ...
    <!-- Banner Start -->
    <section class="main-banner inner-banner back-img" id="main-banner" style="background-image: url('{{ asset('logo/contact.jpg') }}');">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="banner-content"  style="display:none">
                        <h1 class="h1-title wow fadeup-animation" data-wow-delay="0.2s"> {{ trans('home.Contact Us') }} </h1>
						...
						<div class="contact-page-link">
							<div class="contact-page-link-box">
								<div class="contact-page-link-icon">
									<img src="{{ asset('website/assets/images') }}/call-icon.png" alt="Call Icon">
								</div>
							...
							<div class="contact-page-link-box">
								<div class="contact-page-link-icon">
									<img src="{{ asset('website/assets/images') }}/mail-icon.png" alt="Mail Icon">
								</div>
								<div class="contact-page-link-text">
