...
<!-- Banner Start -->
	<section class="main-banner inner-banner back-img" id="main-banner" style="background-image: url('{{ asset('logo/services.jpg') }}');">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="banner-content"  style="display:none">
						<h1 class="h1-title wow fadeup-animation" data-wow-delay="0.2s"> {{ trans('home.advantages') }} </h1>
				...
				<div class="row justify-content-center">
						...
						<div class="service-box wow fadeup-animation" data-wow-delay="0.2s">
							<div class="service-box-text">
								<div class="service-icon">
									<img src="{{ asset('website/assets/images') }}/web-design-icon.png" alt="Web Design">
								</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="service-box idea-research-service wow fadeup-animation" data-wow-delay="0.3s">
							<div class="service-box-text">
								<div class="service-icon">
									<img src="{{ asset('website/assets/images') }}/idea-research-icon.png" alt="Idea & Research">
								</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="service-box seo-service wow fadeup-animation" data-wow-delay="0.4s">
							<div class="service-box-text">
								<div class="service-icon">
									<img src="{{ asset('website/assets/images') }}/seo-icon.png" alt="SEO & Marketing">
								</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="service-box development-service wow fadeup-animation" data-wow-delay="0.5s">
							<div class="service-box-text">
								<div class="service-icon">
									<img src="{{ asset('website/assets/images') }}/web-development-icon.png" alt="Web Development">
								</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="service-box time-data-service wow fadeup-animation" data-wow-delay="0.6s">
							<div class="service-box-text">
								<div class="service-icon">
									<img src="{{ asset('website/assets/images') }}/time-data-icon.png" alt="Real Time & Data">
								</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="service-box analysis-service wow fadeup-animation" data-wow-delay="0.7s">
							<div class="service-box-text">
								<div class="service-icon">
									<img src="{{ asset('website/assets/images') }}/analysis-icon.png" alt="Analysis">
								</div>
