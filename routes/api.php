...
Route::group(['middleware' => ['IsUser'], 'prefix' => 'user'], function () {
    ...
    ->prefix("chat")->group(function () {
        ...
        Route::post('/event_user_send_custom_msg', 'event_user_send_custom_msg')->withoutMiddleware(['auth', 'throttle', 'checkPassword','CheckLang']);
        ...
        Route::post('/event_user_send_event_msg', 'event_user_send_event_msg')->withoutMiddleware(['auth', 'throttle', 'checkPassword','CheckLang']);
    });
