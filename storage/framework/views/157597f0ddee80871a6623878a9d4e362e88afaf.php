...
<html class=''>
   ...
   <head>
    ...
    <style class="cp-pen-styles">
      ...
      #frame .content {
         background-image:url(<?php echo e(asset('event-background-v5.jpg')); ?>?<?php echo e(rand()); ?>);
      ...
      <div id="frame">
         <div class="content">
            ...
            <div class="contact-profile">
               <img src="<?php echo e(asset('user-profile.png')); ?>" style="width: 40px;height:40px" alt="" />
               <p>
                <?php echo e($event_user->name); ?>

               </p>
               <div class="social-media">
                  <a href="<?php echo e(asset('event/logout')); ?>" style="font-weight: bold;color: #000;margin-left: 20px;font-size: 15px;">
                    	تسيجل الخروج
                  </a>
            ...
            <?php echo $__env->make('event.send_msg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/event/show.blade.php ENDPATH**/ ?>