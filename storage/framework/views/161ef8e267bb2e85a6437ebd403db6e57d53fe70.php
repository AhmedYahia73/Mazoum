                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    ...
                                                    <input type="checkbox" class="check_items" name="users[<?php echo e($x); ?>][id]" value="<?php echo e($user->event_user_id); ?>" id="user<?php echo e($user->id); ?>" style="cursor: pointer;margin-right: 5px;width: 20px;height: 20px;">
                                                </div>
                                                </th>

                                                <td>
                                                    <label for="user<?php echo e($user->id); ?>" style="cursor: pointer">
                                                        <?php echo e(@$user->event_user->name); ?>

                                                    </label>
                                                </td>

                                                <td style="direction: ltr;">
                                                   <span> <?php echo e(@$user->event_user->mobile); ?> </span>
                                                </td>

                                                <td>
												   <?php echo e(Carbon\Carbon::parse($user->created_at)->format('Y-m-d h:i A')); ?>

                                                </td>

                                              	<td>
                                                   <span> <?php echo e(@(App\Models\EventUserActions::where('event_id',$user->event_id)->where('event_user_id',$user->event_user_id)->where('action','accept_event')->first())->users_count); ?> </span>
                                                </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/event_details/new_users.blade.php ENDPATH**/ ?>