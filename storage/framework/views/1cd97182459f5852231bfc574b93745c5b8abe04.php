...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom_datables')); ?>/css/buttons.dataTables.min.css" />
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?php echo e(asset('assistant_panel')); ?>" class="app-brand-link">
              <span class="app-brand-logo demo" style="width: auto;height: auto;margin-top: 5px;margin-bottom: 5px;">
              <img src="<?php echo e(asset('logo.png')); ?>" style="height: 50px">
            </a>
          ...
          <ul class="menu-inner py-1">
            <?php echo $__env->make('assistant.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          </ul>
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                  ...
                  <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a class="dropdown-item" href="pages-account-settings-account.html">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              <span class="fw-semibold d-block lh-1"><?php echo e($admin->name); ?></span>
                              <small>
                                admin
                              </small>
                            </div>
                      ...
                      <li>
                        <a class="dropdown-item" href="<?php echo e(asset('assistant_panel/logout')); ?>">
    ...
    <script src="<?php echo e(asset('admin/assets')); ?>/vendor/libs/jquery-repeater/jquery-repeater.js"></script>
    ...
    <script src="<?php echo e(asset('admin/assets')); ?>/vendor/libs/datatables-responsive/datatables.responsive.js"></script>
    <script src="<?php echo e(asset('admin/assets')); ?>/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.js"></script>

    <script src="<?php echo e(asset('custom_datables')); ?>/js/dataTables.buttons.min.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/jszip.min.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/pdfmake.min.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/vfs_fonts.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/buttons.html5.min.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/buttons.print.min.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/dataTables.fixedColumns.min.js"></script>
    <script src="<?php echo e(asset('custom_datables')); ?>/js/dataTables.responsive.min.js"></script>
    ...
    <script src="<?php echo e(asset('bootstrap-sweetalert/sweetalert.js')); ?>"></script>
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/assistant/layouts/master.blade.php ENDPATH**/ ?>