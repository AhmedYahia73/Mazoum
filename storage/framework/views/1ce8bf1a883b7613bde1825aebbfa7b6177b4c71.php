    ...
    <?php if($event_family != null && $event_family->count() > 0): ?>
        ...
        <h2 style="margin-bottom: 20px;font-size: 20px;">  دخول المناسبة  </h2>
		 ...
		 <!--begin::Form-->
        <?php echo Form::open(['url' => "admin/event_family_search",'role'=>'form','id'=>'event_family_search','method'=>'get']); ?>
        ...
        <!--begin::Form-->
        <?php echo Form::open(['url' => "admin/update_event_family",'role'=>'form','id'=>'update_event_family','method'=>'post']); ?>
    ...
    <?php echo Form::open(['url' => "admin/save_event_family",'role'=>'form','id'=>'save_event_family','method'=>'post']); ?>
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/events/enter_event.blade.php ENDPATH**/ ?>