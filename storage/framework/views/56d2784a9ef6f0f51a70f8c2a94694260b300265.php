<?php $__env->startSection('title','تصميمات الموقع'); ?>
...
<div class="row">
  <div class="col-12">
    <p>
      <a href="<?php echo e(asset('admin/web_desgins/create')); ?>" id="addRow" class="btn btn-primary">
              ...
              <tbody>
                ...
                <?php $__currentLoopData = $Item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tr>
                      ...
                      <?php else: ?>
                      <td>
                        <a href="<?php echo e(asset('admin/web_desgins/show-pdf/'.$value->id)); ?>" target="_blank">
                            Open PDF
                        </a>
                      </td>
                      <?php endif; ?>
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?php echo e(url('admin/web_desgins/'). '/' . $value->id . '/edit'); ?>">
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        function DeletingModal(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '<?php echo e(url('admin/web_desgins/destroy')); ?>' + '/' + ID;
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/web_desgins/index.blade.php ENDPATH**/ ?>