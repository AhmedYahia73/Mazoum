...
<div class="row">
  <div class="col-12">
    <p>
      <a href="<?php echo e(asset('admin/assistant/create')); ?>" id="addRow" class="btn btn-primary">
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?php echo e(url('admin/assistant/'). '/' . $value->id . '/edit'); ?>">
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        function DeletingModal(ID) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    window.location.href = '<?php echo e(url('admin/main_categories/destroy')); ?>' + '/' + ID;
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.DeletingModal').on('click', function () {
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        window.location.href = '<?php echo e(url('admin/assistant/destroy')); ?>' + '/' + ID;
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/assistant/index.blade.php ENDPATH**/ ?>