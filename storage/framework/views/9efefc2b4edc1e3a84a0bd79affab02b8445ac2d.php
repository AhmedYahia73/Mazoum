<div style="padding-top: 30px">
    ...
    <?php
        $event_family = App\Models\CustomEventFamily::where('event_id',$Item->id)->get();
    ?>
    ...
    <?php if($event_family != null && $event_family->count() > 0): ?>
        ...
        <!--begin::Form-->
        <?php echo Form::open(['url' => "admin/custom_event_family_search",'role'=>'form','id'=>'event_family_search','method'=>'get']); ?>
        ...
        <!--begin::Form-->
        <?php echo Form::open(['url' => "admin/update_custom_event_family",'role'=>'form','id'=>'update_event_family','method'=>'post']); ?>
    ...
    <?php echo Form::open(['url' => "admin/save_custom_event_family",'role'=>'form','id'=>'save_event_family','method'=>'post']); ?>
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/custom_events/enter_event.blade.php ENDPATH**/ ?>