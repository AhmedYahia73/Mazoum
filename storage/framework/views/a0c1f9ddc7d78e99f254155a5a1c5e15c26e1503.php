    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                <h2>
                    <?php echo e(App\Models\EventMessages::whereHas('event',function($event) { $event->whereIn('is_open',['yes','current']); })->whereIn('mobile',$mobiles_arr)->count()); ?>

                </h2>
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/event-messages/'.$Item->id)); ?>">
                        رسائل الاعتذار
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/all-invited-users/'.$Item->id)); ?>">
                         المدعوين
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/event-qr-details/'.$Item->id)); ?>">
                        QR
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/confirmed-event-details/'.$Item->id)); ?>">
                        تأكيد الحضور
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/not-attend-event-details/'.$Item->id)); ?>">
                        الأعتذار
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/hold-event-details/'.$Item->id)); ?>">
                        بأنتظار الأرسال
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/failed-event-details/'.$Item->id)); ?>">
                      لم يتم التاكيد
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/qr-sent-event-details/'.$Item->id)); ?>">
                        Sent QR
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/congratulations-event-messages-details/'.$Item->id)); ?>">
                        رسائل التهنئة
                    </a>
                </span>
            </div>
  ...
  <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/non-attendance-event-details/'.$Item->id)); ?>">
                    	عدم الحضور
                    </a>
                </span>
            </div>
    ...
    <div class="col-xl-3 col-3" style="margin-bottom:20px">
        <div class="card">
            <div class="card-body text-center pb-0" style="position: relative;padding-bottom: 20px !important;">
                ...
                <span class="text-muted">
                    <a href="<?php echo e(asset('admin/confirmed-users-web-chat/'.$Item->id)); ?>">
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/events/event_report.blade.php ENDPATH**/ ?>