<?php $__env->startSection('title',trans('home.edit_user')); ?>
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-header">
          <h4 class="card-title">
            <?php echo e(trans('home.edit_user')); ?>
            ...
            <div class="nav-align-top mb-4">
                ...
                <div class="tab-content" style="padding-top: 0;">
                    ...
                    <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                        <?php echo $__env->make('admin.users.edit_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                        <?php echo $__env->make('admin.users.user-invoices', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
    ...
    <script>
	 ...
	 <script>
      ...
      function DeletingModal(ID) {
          ...
          function (isConfirm) {
              if (isConfirm) {
                  window.location.href = '<?php echo e(url('admin/user-invoice/destroy')); ?>' + '/' + ID;
              }
          });
      }
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>