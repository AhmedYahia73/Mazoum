...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-12" style="max-width: 500px">
                ...
                <div class="card p-3 shadow-sm text-center" style="border-radius: 0px;padding: 20px 35px !important;">
                    ...
                    <img src="<?php echo e(@$event_user->event->file); ?>" class="main-image mb-3" alt="Invitation Image">

                    <div class="btn" onclick="location.href='https://www.google.com/maps?q=<?php echo e(@$event_user->event->lat); ?>,<?php echo e(@$event_user->event->long); ?>'" style="cursor: pointer;width: 100%;color: #000;border: 1px solid #eee;border-radius: 0;padding-top: 10px;padding-bottom: 10px;text-align: right;margin-bottom: 10px;box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                        <img src="<?php echo e(url('icons/location.png')); ?>" class="me-1" style="width: 30px;" alt="Location Icon">
                        <span>
                            <?php echo e(@$event_user->event->address); ?>
                    ...
                    <div class="btn" style="background-color: #F3F6F2; width: 100%;color: #000;border: 1px solid #eee;border-radius: 0;padding-top: 10px;padding-bottom: 10px;text-align: right;margin-bottom: 10px;box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                        <span style="color: #707070;"> <?php echo e($event_user->name); ?> </span>
                        <?php if($latest_action != null): ?>
                        <span style="color: #707070;"> الحالة الحالية : <?php echo e($latest_action->action == 'accept_event' || $latest_action->action == 'yes_receive_congratulation' ? 'تاكيد' : 'رفض'); ?></span>
                        <?php endif; ?>
                    </div>

                    <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','accept_event')->first() != null): ?>
                    <div class="btn" style="background-color: #F3F6F2; width: 100%;color: #000;border: 1px solid #eee;border-radius: 0;padding-top: 10px;padding-bottom: 10px;text-align: right;margin-bottom: 10px;box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                        <span style="color: #707070;">  عدد حضور المناسبة : <?php echo e(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','accept_event')->first()->users_count); ?> </span>
                    </div>
                    <?php else: ?>
                    <div class="btn" style="background-color: #F3F6F2; width: 100%;color: #000;border: 1px solid #eee;border-radius: 0;padding-top: 10px;padding-bottom: 10px;text-align: right;margin-bottom: 10px;box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                        <span style="color: #707070;">  عدد حضور المناسبة : <?php echo e($event_user->users_count); ?> </span>
                    </div>
                    <?php endif; ?>

                    <?php if(@$qr_row && $qr_row->qr != null): ?>
                    <div>

                        <div style="border: 1px dotted #DDD;border-radius: 8px;margin-bottom: 15px;margin-top: 15px;">
                            <img src="<?php echo e(url('qr_code/'.$qr_row->qr)); ?>?<?php echo e(rand()); ?>" style="max-width: 100%;margin-bottom: 15px;margin-top: 10px;border-radius: 0px;height: 220px;">
                        </div>
                        ...
                        <div style="margin-bottom: 20px">
                            <button class="btn btn-outline-danger w-100 mb-2" data-bs-toggle="modal" data-bs-target="#ViewQR" style="height: 25px;line-height: 15px;background: #000;border-color: #000;color: #fff;padding: 0;width: 70px !important;">
                                <img src="<?php echo e(url('icons/eye.png')); ?>" style="width: 17px;">
                                <span style="font-size: 13px;">  معاينة </span>
                            </button>
                            <a href="<?php echo e(url('qr_code/'.$qr_row->qr)); ?>?<?php echo e(rand()); ?>" download="download<?php echo e(rand()); ?>" class="btn btn-outline-danger w-100 mb-2" style="height: 25px;line-height: 17px;background: #000;border-color: #000;color: #fff;padding: 0;width: 80px !important;">
                                <img src="<?php echo e(url('icons/download.png')); ?>" style="width: 16px;height: 14px;">
                    ...
                    <?php if($latest_action == null): ?>
                        ...
                        <button class="btn btn-success w-100 mb-2" data-bs-toggle="modal" data-bs-target="#SaveAcceptAction" style="background-color: #1C6402;border-color: #1C6402;height: 53px;">
                            <img src="<?php echo e(url('icons/true.png')); ?>" style="width: 23px;margin-left: 6px;">
                        ...
                        <button class="btn btn-outline-danger w-100 mb-2" data-bs-toggle="modal" data-bs-target="#SendRefuseMessage" style="height: 53px;">
                            <img src="<?php echo e(url('icons/false.png')); ?>" style="width: 23px;margin-left: 6px;">
                            <span style="font-weight: bold;font-size: 20px;"> اعتذار الدعوة </span>
                        </button>

                    <?php elseif($latest_action != null && ($latest_action->action == 'accept_event' || $latest_action->action == 'yes_receive_congratulation')): ?>

                        <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','refuse_event')->count() == 0): ?>
                        <button class="btn btn-outline-danger w-100 mb-2" data-bs-toggle="modal" data-bs-target="#SendRefuseMessage" style="height: 53px;">
                            <img src="<?php echo e(url('icons/false.png')); ?>" style="width: 23px;margin-left: 6px;">
                            <span style="font-weight: bold;font-size: 20px;"> اعتذار الدعوة </span>
                        </button>
                        ...
                        <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','yes_receive_congratulation')->count() == 0): ?>
                        <button class="btn btn-success w-100"  data-bs-toggle="modal" data-bs-target="#SendCustomMessage" style="background-color: #333432;border-color: #333432;height: 53px;">
                            <img src="<?php echo e(url('icons/send.png')); ?>" style="width: 23px;margin-left: 6px;">
                        ...
                        <button class="btn btn-success w-100"  data-bs-toggle="modal" data-bs-target="#ViewCustomMessage" style="background-color: #333432;border-color: #333432;height: 53px;">
                            <img src="<?php echo e(url('icons/eye.png')); ?>" style="width: 23px;margin-left: 6px;">
                            <span style="font-weight: bold;font-size: 20px;"> معاينة رسالة التهنئة </span>
                        </button>
                        <?php endif; ?>

                    <?php elseif($latest_action != null && ($latest_action->action == 'refuse_event' || $latest_action->action == 'yes_receive_apology')): ?>

                        <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','accept_event')->count() == 0): ?>
                        <button class="btn btn-success w-100 mb-2" data-bs-toggle="modal" data-bs-target="#SaveAcceptAction" style="background-color: #1C6402;border-color: #1C6402;height: 53px;">
                            <img src="<?php echo e(url('icons/true.png')); ?>" style="width: 23px;margin-left: 6px;">
                            <span style="font-weight: bold;font-size: 20px;">  قبول الدعوة </span>
                        </button>
                        ...
                        <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','yes_receive_apology')->count() > 0): ?>
    ...
    <div class="modal fade" id="SaveAcceptAction" tabindex="-1" aria-labelledby="SaveAcceptActionLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('url' => 'new-save-event-user-action', 'id' => 'save-event-user-action')); ?>
                ...
                <input type="hidden" name="event_user_id" value="<?php echo e($event_user->id); ?>">
                <input type="hidden" name="code" value="<?php echo e($event_user->code); ?>">
                ...
                <div class="modal-body">
                    <div class="">
                        ...
                        <select name="users_count" class="form-control m-bootstrap-select m_selectpicker" required>
                                ...
                                <?php for($i = 1; $i <= $event_user->users_count; $i++): ?>
    ...
    <div class="modal fade" id="SendCustomMessage" tabindex="-1" aria-labelledby="SendCustomMessageLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('url' => 'new-save-event-user-action', 'id' => 'save-event-user-action2')); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        ...
                        <textarea name="msg" required rows="4" class="form-control" placeholder="محتوي الرسالة"><?php echo e(old('message')); ?></textarea>
                    </div>
    ...
    <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','yes_receive_congratulation')->first() != null): ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        ...
                        <textarea name="msg" required rows="4" class="form-control" placeholder="محتوي الرسالة"><?php echo e(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','yes_receive_congratulation')->first()->msg); ?></textarea>
                    </div>
    ...
    <?php if(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','yes_receive_apology')->first() != null): ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        <label style="display: block;margin-bottom: 5px;"> محتوي الرسالة ,, </label>
                        <textarea name="msg" required rows="4" class="form-control" placeholder="محتوي الرسالة"><?php echo e(\App\Models\EventUserActions::where('event_user_id', $event_user->id)->where('action','yes_receive_apology')->first()->msg); ?></textarea>
                    </div>
    ...
    <div class="modal fade" id="SendRefuseMessage" tabindex="-1" aria-labelledby="SendRefuseMessageLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('url' => 'new-save-event-user-action', 'id' => 'save-event-user-action3')); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        ...
                        <textarea name="msg" rows="4" class="form-control" placeholder="محتوي الرسالة"><?php echo e(old('msg')); ?></textarea>
                    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div style="text-align: center">
                    <img src="<?php echo e(url('qr_code/'.$qr_row->qr)); ?>?<?php echo e(rand()); ?>" style="max-width: 100%;border-radius: 16px;height: 300px;">
                </div>
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/mobile_events/index.blade.php ENDPATH**/ ?>