...
<html
  ...
  <head>
    ...
    <?php echo $__env->yieldContent('header_v2'); ?>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?php echo e(asset('admin')); ?>" class="app-brand-link">
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                  ...
                  <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                        <a class="dropdown-item" href="<?php echo e(asset('admin/logout')); ?>">
    ...
    <?php echo $__env->yieldContent('footer_v2'); ?>


  </body>
</html>
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>