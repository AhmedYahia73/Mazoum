      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <ul class="nav nav-tabs" style="margin-bottom:20px">
            <li class="nav-item">
              <a class="nav-link <?php echo e(request()->is('admin/sa-events') ? 'active active_nav_item' : ''); ?>" aria-current="page" href="<?php echo e(asset('admin/sa-events')); ?>">
              	المناسبات
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo e(request()->is('admin/sa-current-events') ? 'active active_nav_item' : ''); ?>" href="<?php echo e(asset('admin/sa-current-events')); ?>">
              	  المناسبات الحاليه
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo e(request()->is('admin/sa-closed-events') ? 'active active_nav_item' : ''); ?>" href="<?php echo e(asset('admin/sa-closed-events')); ?>">
              	المناسبات المنهية
              </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('admin/sa-deleted-events') ? 'active active_nav_item' : ''); ?>" href="<?php echo e(asset('admin/sa-deleted-events')); ?>">
                    المناسبات المحذوفه
                </a>
              </li>
          </ul>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php if(request()->is('admin/sa-events')): ?>
                                    ...
                                    <?php elseif(request()->is('admin/sa-current-events')): ?>
                                    <a onclick="return closeEventModal(<?php echo e($value->id); ?>);" class="dropdown-item closeEventModal" name="<?php echo e($value->id); ?>" href="javascript:void(0);">
                                        <i class="bx bx-window-close me-1"></i> المناسبات المنهية
                                    </a>
                                    <?php else: ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/sa_events/index.blade.php ENDPATH**/ ?>