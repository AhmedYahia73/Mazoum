            ...
            <div class="card">
                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(asset('admin/events/'.$Item->id.'/send-events')); ?>" class="nav-link active" aria-selected="true">
                                أرسال الدعوات
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                      	...
                      	<li class="nav-item">
                            <a href="<?php echo e(asset('admin/events/'.$Item->id.'/event-location')); ?>" class="nav-link" aria-selected="false">
                                موقع الحدث
                            </a>
                        </li>
                    ...
                    <div class="nav-align-top mb-4">
                        ...
                        <div class="tab-content" style="padding-top: 0;">
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel" style="padding-top: 30px">
                                <?php echo $__env->make('admin.events.send_events', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
        ...
        $(document).ready(function () {
            ...
            $('.old_send_btn').click(function() {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $('#send_event_users').attr('action','<?php echo e(asset('admin/send_event_users')); ?>').attr('method','post').submit();
                        }
                    }
                );
            });
            ...
            $('.send_location').on('click', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '<?php echo e(url('admin/send-event-location')); ?>' + '/' + ID;
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/send_events/index.blade.php ENDPATH**/ ?>