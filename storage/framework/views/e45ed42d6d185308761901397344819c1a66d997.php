            ...
            <div class="card">
                ...
                <div class="card-header" style="padding-bottom: 0;margin-top: 15px;">
                    <ul class="nav nav-pills mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(asset('admin/events/'.$Item->id.'/edit')); ?>" class="nav-link active" aria-selected="true">
                                تعديل
                            </a>
                        </li>
                    ...
                    <div class="nav-align-top mb-4">
                        ...
                        <div class="tab-content" style="padding-top: 0;">
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel" style="padding-top: 30px">
                                <?php echo $__env->make('admin.events.edit_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/events/edit.blade.php ENDPATH**/ ?>