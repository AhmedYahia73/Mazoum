...
<div class="row">
    <div class="col-lg-12">
        ...
        <table class="table" id="users_table" style="table-layout: fixed">
            <thead>
                <tr>
                    <th> م </th>
                    <th>  أسم المستخدم </th>
                ...
                <?php $__currentLoopData = $user_events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td style="color: #000">
                      	...
                      	<td class="qr-cell">
                          <a href="<?php echo e($user_event->qr); ?>" download="<?php echo e($user_event->name); ?>">
                          <img src="<?php echo e($user_event->qr); ?>" style="max-width:150px">
                          </a>
                        </td>
...
<?php /**PATH /home/mazoom-kw/htdocs/mazoom-kw.com/project-app/resources/views/admin/custom_events/users.blade.php ENDPATH**/ ?>